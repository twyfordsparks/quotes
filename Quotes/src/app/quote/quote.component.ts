...
export class QuoteComponent implements OnInit {
  quotes = [
    new Quote(1,'Its not lack of love,but a lack of friendship that makes unhappy marriages','John',new Date(25,4,2019)),
    new Quote(2,'We accept the love we think we desreve','Victor.', new Date(25, 4, 2019)),
    new Quote(3,'Dont cry because it is over,smile because it happened','Mimi.', new Date(25, 4, 2019)),
